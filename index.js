...
bannerImg.style.backgroundImage =
  "url('./1페이지/배너이미지/" + randomNumber + ".png')";
  ...
  switch (car_name) {
    case 'KIA K9':
      ...
      var carInfoRightElements =
        parentElement.querySelectorAll('.car_info_right');
...
function review(car_num) {
  ...
  switch (car_num) {
    case 1:
      review_star.src = './리뷰/10-1.png';
      review_six.src = './리뷰/10-2.png';

      star[0].innerHTML = '<img src="./1페이지/star.png">' + '9.24';
      or[0].textContent =
        '가성비하면 역시 국산차 입니다. 실내공간도 넓고 편의사항도 많고 잘 타고 있어요.';
      day[0].textContent =
        'wod1**** \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa03일 전';

      star[1].innerHTML = '<img src="./1페이지/star.png">' + '9.32';
      or[1].textContent =
        '아주 만족하고 타고 있습니다. 회전축도 작아서 초보분들도 잘 탈 수 있습니다.';
      day[1].textContent =
        'vowe**** \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa013일 전';

      break;

    case 2:
      review_star.src = './리뷰/6-1.png';
      review_six.src = './리뷰/6-2.png';

      star[0].innerHTML = '<img src="./1페이지/star.png">' + '9.00';
      or[0].textContent = '샀으니까 타고 다녀야죠.';
      day[0].textContent =
        'udw2**** \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa06일 전';

      star[1].innerHTML = '<img src="./1페이지/star.png">' + '9.32';
      or[1].textContent =
        '저는 만족하고 타고 있습니다. 제 생각엔 호불호 갈리는 차량 같습니다.';
      day[1].textContent =
        'ewwq**** \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa011일 전';

      break;

    case 3:
      review_star.src = './리뷰/8-1.png';
      review_six.src = './리뷰/8-2.png';

      star[0].innerHTML = '<img src="./1페이지/star.png">' + '9.21';
      or[0].textContent = '생각 이상으로 연비가 좋습니다. 디자인도 괜찮습니다.';
      day[0].textContent =
        '29ep**** \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa05일 전';

      star[1].innerHTML = '<img src="./1페이지/star.png">' + '9.32';
      or[1].textContent = '내부가 만족스럽네요. 후회없는 선택이었네요.';
      day[1].textContent =
        'qq2q**** \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa07일 전';
