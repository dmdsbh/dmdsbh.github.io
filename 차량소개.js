...
function change_brand(brand, button) {
  ...
  switch (brand) {
    case 'KIA':
      ...
      // 이미지 바꾸기
      //소형
      imageElements[0].src = './기아/니로EV 2.png';
      imageElements[1].src = './기아/니로 하이브리드 2.png';
      imageElements[2].src = './기아/셀토스 2.png';
      ...
      // 중형
      imageElements[8].src = './K5 2.png';
      imageElements[9].src = './기아/소렌토하이브리드 2.png';
      ...
      // 준대형
      imageElements[10].src = './기아/K8 2.png';
      imageElements[11].src = './기아/모하비 2.png';
      ...
      // 니로EV
      var tap_num = 0;
      var carInfoRightElements =
        parentElement[tap_num].querySelectorAll('.car_info_right');
    ...
    case '현대':
      ...
      // 이미지 바꾸기
      // 소형
      imageElements[0].src = './현대/코나 2.png';
      ...
      // 준중형
      imageElements[4].src = './현대/아반떼 2.png';
      imageElements[5].src = './현대/아반떼N 2.png';
      imageElements[6].src = './현대/아이오닉 5N 2.png';
      imageElements[7].src = './현대/투싼 2.png';
      ...
      // 중형
      imageElements[8].src = './현대/소나타 2.png';
      imageElements[9].src = './현대/싼타페 2.png';
      ...
      // 준대형
      imageElements[10].src = './현대/그랜저 2.png';
      imageElements[11].src = './현대/팰리세이드 2.png';
      ...
      // 대형
      imageElements[14].src = './현대/스타리아라운지 2.png';
    ...
    case '르노코리아':
      ...
      // 이미지 바꾸기
      //소형
      imageElements[0].src = './르노코리아/XM3 2.png';
      imageElements[1].src = './르노코리아/XM3 E TECH 2.png';
      ...
      // 중형
      imageElements[8].src = './르노코리아/SM6 2.png';
      imageElements[9].src = './르노코리아/QM6 2.png';
    ...
    case 'KG':
      ...
      // 이미지 바꾸기
      //준중형
      imageElements[4].src = './KG/코란도 2.png';
      ...
      // 중형
      imageElements[8].src = './KG/토레스 2.png';
      imageElements[9].src = './KG/토레스 EV X 2.png';
      ...
      // 준대형
      imageElements[10].src = './KG/렉스턴 2.png';
      imageElements[11].src = './KG/렉스턴스포츠 2.png';
      imageElements[12].src = './KG/칸 2.png';
    ...
    case '쉐보레':
      ...
      // 이미지 바꾸기
      //소형
      imageElements[0].src = './트레일 블레이저 2.png';
      imageElements[1].src = './트랙스 크로스오버 2.png';
      ...
      // 중형
      imageElements[8].src = './이쿼녹스 2.png';
      ...
      // 준대형
      imageElements[10].src = './트래버스 2.png';
      ...
      // 대형
      imageElements[14].src = './대형 타호 2.png';
...
function detail(car_num, tap_num) {
  ...
  imgTags.forEach(function (imgTag, index) {
    if (index + 1 === 2) {
      imgTag.src = './1페이지/선택버튼.png';
    } else {
      imgTag.src = './1페이지/버튼.png';
    }
  });
...
var review_p = [
  ...
  '샀으니까 타고 다녀야죠.',
  '저는 만족하고 타고 있습니다. 제 생각엔 호불호 갈리는 차량 같습니다.',
  '뭐가 안좋다고들 하는지 모르겠네요. 저는 만족하고 있습니다.',
...
var day_p = [
  3, 13, 2, 8, 5, 7, 12, 9, 1, 14, 6, 11, 4, 10, 3, 13, 2, 8, 5, 7, 12, 9, 1,
  14, 6, 11, 4, 10, 3, 13, 2, 8, 5, 7, 12, 9, 1, 14, 6, 11, 4, 10, 3, 13, 2, 8,
  5, 7, 12, 9, 1, 14, 6, 11, 4, 10, 3, 13, 2, 8, 5, 7, 12, 9, 1, 14, 6, 11, 4,
  10,
];
...
function review(car_num, tap_num) {
  ...
  review_img[idx].src = './리뷰/' + (number2 + 1) + '-1.png';
  review_img[idx + 1].src = './리뷰/' + (number2 + 1) + '-2.png';
  console.log(review_img[0].src);

  Review_div1.querySelectorAll('p').forEach(function (pTag, index) {
    if (index === 0) {
      pTag.innerHTML = '<img src="./1페이지/star.png">' + star_p[number];
    } else if (index === 1) {
  ...
  Review_div2.querySelectorAll('p').forEach(function (pTag, index) {
    if (index === 0) {
      pTag.innerHTML = '<img src="./1페이지/star.png">' + star_p[number + 1];
    } else if (index === 1) {
